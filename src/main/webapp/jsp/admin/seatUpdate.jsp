    ...
    <div class="col-md-10">
        ...
        <div class="panel panel-info">
            ...
            <div class="panel-body">
                ...
                <form:form class="form-horizontal" action="admin/updateSeat" method="post"
                           modelAttribute="seat">
                    <form:hidden path="seatid"/>
                    <form:hidden path="spic"/>
                    <div class="form-group">
                        <label class="col-sm-4 control-label">座位名称</label>
                        <div class="col-sm-4">
                            <form:input path="seatname" class="form-control"	placeholder="请输入名称" />
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            ...
                            <img alt="" src="uploadfiles/${seat.spic}" width="80px">
                        </div>
                    </div>
                    <div class="form-group">
